...
import com.jemimah.autosnap.utils.RetrofitInstance;
...
//        captureButton.setOnClickListener(view -> initiateCapture(5, 5000));
    ...
    public void initiateCapture(final int numOfPictures, final int delay) {
    ...
    private void capturePicture() {
        ...
        try {
            ...
            // Create a directory path for the "Pictures" folder
            File picturesDirectory = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);

            // Create a subdirectory within "Pictures" if needed
            File myAppSubdirectory = new File(picturesDirectory, "AutoSnap");

            if (!myAppSubdirectory.exists()) {
                if (!myAppSubdirectory.mkdirs()) {
                    // Handle directory creation failure
                    Log.e("YourTag", "Failed to create directory");
                    return;
                }
            }
            final File file = new File(myAppSubdirectory, "pic_" + System.currentTimeMillis() + ".jpg");
...
//                    Toast.makeText(MainActivity.this, "Saved:" + file, Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage(File imageFile) {
        Log.d(TAG, "uploadImage: here");
        // Create a RequestBody from the saved image file
        ...
        RetrofitInstance.getInstance(MainActivity.this)
                .getApi()
